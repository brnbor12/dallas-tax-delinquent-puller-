...
async def get_status(db: AsyncSession = Depends(get_db)):
    ...
    return {
        ...
        "scrapers": [
            ...
            {"key": "fl_polk_probate", "county": "Polk, FL", "signal": "probate", "freq": "weekly", "status": "pending", "last_result": "—"},
            {"key": "fl_polk_eviction", "county": "Polk, FL", "signal": "eviction", "freq": "weekly", "status": "pending", "last_result": "—"},
            {"key": "fl_polk_foreclosure", "county": "Polk, FL", "signal": "pre_foreclosure", "freq": "weekly", "status": "pending", "last_result": "—"},
            {"key": "fl_polk_lis_pendens", "county": "Polk, FL", "signal": "lien", "freq": "weekly", "status": "pending", "last_result": "—"},
